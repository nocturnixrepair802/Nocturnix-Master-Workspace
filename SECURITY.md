...
Nocturnix v0.1.3 remains development-only. Do not deploy it as a production service. Development identity headers are not production authentication. Live providers, credentials, OAuth tokens, paid AI calls, notifications, and customer systems remain disabled.
